...
parser.add_argument("--model", type=str, default='roberta') # bert,roberta,t5
# parser.add_argument("--model_name_or_path", default='/home/zy-4090-1/hqq/conversation_recommendation/models/chinese-roberta-wwm-ext')#bert分词器
parser.add_argument("--model_name_or_path", default='/home/zy-4090-1/hqq/conversation_recommendation/models/hub/AI-ModelScope/roberta-base')
# parser.add_argument("--model_name_or_path", default='/home/zy-4090-1/hqq/conversation_recommendation/models/hub/AI-ModelScope/t5-base')
# parser.add_argument("--model_name_or_path", default='/home/zy-4090-1/hqq/conversation_recommendation/models/hub/langboat/mengzi-t5-base')
# parser.add_argument("--model_name_or_path", default='/home/zy-4090-1/hqq/conversation_recommendation/models/bert_chinese')
# parser.add_argument("--model_name_or_path", default='/home/zy-4090-1/hqq/conversation_recommendation/models/bert_base_cased')
...
if args.dataset == "DuDialRec":
    dataset['train'] = DuDialRecProcessor().get_train_examples("datasets/TextClassification/DuDialRec")
    # dataset['dev'] = DuDialRecProcessor().get_dev_examples("datasets/TextClassification/DuDialRec/Du/30")
    dataset['test'] = DuDialRecProcessor().get_test_examples("datasets/TextClassification/DuDialRec")
    ...
    dataset['train'] = JDDCProcessor().get_train_examples("datasets/TextClassification/JDDC")
    dataset['test'] = JDDCProcessor().get_test_examples("datasets/TextClassification/JDDC")
    class_labels = JDDCProcessor().get_labels()
    scriptsbase = "TextClassification/JDDC"
    scriptformat = "txt"
    cutoff = 0.5
    max_seq_l = 256
    batch_s = args.batch_size
...
elif args.verbalizer == "kpt1":
    myverbalizer = KnowledgeableVerbalizer(tokenizer, classes=class_labels, candidate_frac=cutoff,
                                           pred_temp=args.pred_temp, max_token_split=args.max_token_split).from_file(
        path=f"./scripts/{scriptsbase}/kpt1_translate_verbalizer.{scriptformat}")
elif args.verbalizer == "kpt2":
    myverbalizer = KnowledgeableVerbalizer(tokenizer, classes=class_labels, candidate_frac=cutoff,
                                           pred_temp=args.pred_temp, max_token_split=args.max_token_split).from_file(
        path=f"./scripts/{scriptsbase}/kpt2_translate_verbalizer.{scriptformat}")
elif args.verbalizer == "kpt3":
    myverbalizer = KnowledgeableVerbalizer(tokenizer, classes=class_labels, candidate_frac=cutoff,
                                           pred_temp=args.pred_temp, max_token_split=args.max_token_split).from_file(
        path=f"./scripts/{scriptsbase}/kpt3_translate_verbalizer.{scriptformat}")
elif args.verbalizer == "kpt4":
    myverbalizer = KnowledgeableVerbalizer(tokenizer, classes=class_labels, candidate_frac=cutoff,
                                           pred_temp=args.pred_temp, max_token_split=args.max_token_split).from_file(
        path=f"./scripts/{scriptsbase}/kpt4_translate_verbalizer.{scriptformat}")
elif args.verbalizer == "kpt5":
    myverbalizer = KnowledgeableVerbalizer(tokenizer, classes=class_labels, candidate_frac=cutoff,
                                           pred_temp=args.pred_temp, max_token_split=args.max_token_split).from_file(
        path=f"./scripts/{scriptsbase}/kpt5_translate_verbalizer.{scriptformat}")
...
if args.verbalizer in ["kpt","kpt1","kpt2","kpt3","kpt4","kpt5", "manual",'ex_re1']:
